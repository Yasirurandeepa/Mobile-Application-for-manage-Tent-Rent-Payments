...
export class HomePage {
  ...
  data = { amount:0,t2:500,t4:1000,t6:1500,t8:2000,t16:3000,s1:350,s2:600,m1:500,m2:800,bulb:100 };
  ...
  calculateAmount(){
    if(!/^[0-9]+$/.test(this.number.value) || this.number.value.length !== 10) {        //check valid phone nummber
      ...
      this.total = this.tent_2.value * this.data.t2 + this.tent_4.value * this.data.t4 + this.tent_6.value * this.data.t6 +
        this.tent_8.value * this.data.t8 + this.tent_16.value * this.data.t16 + this.bag_1.value * this.data.s1 +
        this.bag_2.value * this.data.s2 + this.mattrice_1.value * this.data.m1 + this.mattrice_2.value * this.data.m2 +
        this.bulb.value * this.data.bulb;
